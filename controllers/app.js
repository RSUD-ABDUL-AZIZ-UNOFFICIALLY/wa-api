...
//   const getChats = await client
//     .getChatById(msg.from)
//     .then((data) => {
//       // console.log(data);
...
//     var getContact = await client
//       .getContactById(msg.author)
//       .then((contacts) => {
...
//           const fullFilename =
//             mediaPath + getContact + timeStamp + "." + extension;
//           // Save to file
//           try {
